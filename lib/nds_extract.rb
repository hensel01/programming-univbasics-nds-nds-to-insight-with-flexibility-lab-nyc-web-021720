...
def movies_with_director_key(name, movies_collection)	
  ...
  # GOAL: For each Hash in an Array (movies_collection), provide a collection	  # GOAL: For each Hash in an Array (movies_collection), provide a collection
  # of movies and a directors name to the movie_with_director_name method	  # of movies and a directors name to the movie_with_director_name method
  # and accumulate the returned Array of movies into a new Array that's	  # and accumulate the returned Array of movies into a new Array that's
...
def movies_with_directors_set(source)	
  ...
  #	  #
  # Array of Arrays containing all of a director's movies. Each movie will need	  # Array of Arrays containing all of a director's movies. Each movie will need
  # to have a :director_name key added to it.	  # to have a :director_name key added to it.
  aoa_movies = []
  i = 0
